interface  RDI_if#(
    ...
    import pckg::*;   // ← brings rdi_state_sts_t and rdi_state_req_t into scope

    // Typed as enums — Questa will show names in the waveform
    rdi_state_sts pl_state_sts;
    rdi_state_req lp_state_req;
