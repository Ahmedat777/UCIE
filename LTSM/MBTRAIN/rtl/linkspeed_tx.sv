    ...
    always @(*) begin
        ...
        case(current_state_tx)
            ...
            ERROR_HANDLING: begin
                ...
                else if(i_sb_valid && i_sb_msg == ERROR_RESP) 
                    next_state_tx = ERROR_HANDLING_CLEAR;
                else
                    next_state_tx = ERROR_HANDLING;
                end
            
            ERROR_HANDLING_CLEAR: begin
                if(!i_enable)
                    next_state_tx = IDLE;
                else if(any_ok)
           ...
           // o_clear_phy_in_retrain_flag <= 0;
            ...
            case(next_state_tx)
                ...
                EXIT_SPEED_DEGRADE: begin
                    ...
                    // since we are entering speed degrade mode then we will stay on the results from
