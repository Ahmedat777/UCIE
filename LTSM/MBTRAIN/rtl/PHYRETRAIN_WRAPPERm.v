...
wire    [3:0]             wp_tx_encoded_SB_msg, wp_rx_encoded_SB_msg; 	
...
TX_PHYRETRAIN TX_inst (
    .clk                            (i_clk),
    .rst_n                          (i_rst_n),
    .i_en                           (i_phyretrain_en),
    ...
    .i_valid_rx                     (wp_rx_valid),
    .i_sideband_valid               (i_rx_msg_valid),
    .i_sideband_message             (i_decoded_SB_msg),
    .o_sideband_message             (wp_tx_encoded_SB_msg),
    .o_sideband_encoding            (o_tx_msg_info),
    .o_test_ack                     (wp_tx_PHYRETRAIN_end),
...
TX_PHYRETRAIN TX_inst (
    ...
    .i_sideband_valid               (i_rx_msg_valid),
    .i_sideband_message             (i_decoded_SB_msg),
    .o_sideband_message             (wp_tx_msg),
    .o_sideband_encoding            (wp_tx_info), // متوصل بالسلك الداخلي
    .o_test_ack                     (wp_tx_done),
    .o_valid_tx                     (wp_tx_valid)
);
*/
/************
...
RX_PHYRETRAIN   RX_inst (
  /*  .i_clk                      (i_clk),
    ...
    .i_sideband_message           (i_decoded_SB_msg),
    .o_sideband_message        (wp_rx_encoded_SB_msg),
    .o_test_ack        (wp_rx_PHYRETRAIN_end),
