module Traincenter_cal_wrapper # ( parameter SB_MSG_WIDTH = 4) 
(
...
traincenter_cal_tx #(.SB_MSG_WIDTH(SB_MSG_WIDTH)) traincenter_cal_tx_u0 (
  //inputs
   .i_clk(i_clk),
   .i_rst_n(i_rst_n),
   .i_enable(i_enable),
...
traincenter_cal_rx #(.SB_MSG_WIDTH(SB_MSG_WIDTH)) traincenter_cal_rx_u0 (
  //inputs
   .i_clk(i_clk),
   .i_rst_n(i_rst_n),
   .i_enable(i_enable),
