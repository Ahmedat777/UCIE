...
module REVERSALMB_Wrapper (
    ...
    output sb_msg_id  o_TX_SbMessage,
...
wire sb_msg_id TX_SbMessage_Module;
wire sb_msg_id TX_SbMessage_ModulePartner;
...
assign o_TX_SbMessage                          = ValidOutDatat_ModulePartner ? TX_SbMessage_ModulePartner :
                                                 ValidOutDatat_Module ? TX_SbMessage_Module : SB_MBINIT_REVERSALMB_INIT_REQ;
